...
Answer.propTypes = {
  answer: (external_prop_types_default()).string.isRequired
};
...
Clue.propTypes = {
  clue: (external_prop_types_default()).object.isRequired,
  currentRow: (external_prop_types_default()).number.isRequired,
  hidden: (external_prop_types_default()).bool.isRequired
};
...
Letter.propTypes = {
  animate: (external_prop_types_default()).bool.isRequired,
  direction: (external_prop_types_default()).string.isRequired,
  focus: (external_prop_types_default()).bool.isRequired,
  isComplete: (external_prop_types_default()).bool.isRequired,
  isCurrentRow: (external_prop_types_default()).bool.isRequired,
  isSpace: (external_prop_types_default()).bool.isRequired,
  letterNumber: (external_prop_types_default()).number.isRequired,
  onBackspace: (external_prop_types_default()).func.isRequired,
  onEnter: (external_prop_types_default()).func.isRequired,
  onChange: (external_prop_types_default()).func.isRequired,
  onRefocusComplete: (external_prop_types_default()).func.isRequired,
  triggerFocus: (external_prop_types_default()).bool.isRequired,
  status: (external_prop_types_default()).string,
...
Phrase.propTypes = {
  correctAnswer: (external_prop_types_default()).string.isRequired,
  displayMessage: (external_prop_types_default()).func.isRequired,
  guess: (external_prop_types_default()).string.isRequired,
  isComplete: (external_prop_types_default()).bool.isRequired,
  isCurrentRow: (external_prop_types_default()).bool.isRequired,
  onFail: (external_prop_types_default()).func.isRequired,
  onPass: (external_prop_types_default()).func.isRequired,
  onRefocusComplete: (external_prop_types_default()).func.isRequired,
  phraseNumber: (external_prop_types_default()).number.isRequired,
  triggerFocus: (external_prop_types_default()).bool.isRequired
};
...
Guesses.propTypes = {
  answerDescription: (external_prop_types_default()).string.isRequired,
  currentRow: (external_prop_types_default()).number.isRequired,
  correctAnswer: (external_prop_types_default()).string.isRequired,
  displayMessage: (external_prop_types_default()).func.isRequired,
  guesses: (external_prop_types_default()).array.isRequired,
  hidden: (external_prop_types_default()).bool.isRequired,
  onGuessFail: (external_prop_types_default()).func.isRequired,
  onPuzzlePass: (external_prop_types_default()).func.isRequired,
  remainingGuesses: (external_prop_types_default()).number.isRequired,
  status: (external_prop_types_default()).string.isRequired
};
...
Message.propTypes = {
  ...
  ttl: (external_prop_types_default()).number,
  onTtl: (external_prop_types_default()).func.isRequired
};
...
StatisticsModal.propTypes = {
  ...
  stats: (external_prop_types_default()).object.isRequired,
  testing: (external_prop_types_default()).bool
};
...
SupportingContent.propTypes = {
  headline: (external_prop_types_default()).string.isRequired,
  link: (external_prop_types_default()).string.isRequired,
  summary: (external_prop_types_default()).string.isRequired,
  thumbnail: (external_prop_types_default()).string.isRequired,
  hidden: (external_prop_types_default()).bool.isRequired
};
...
Puzzle.propTypes = {
  fetchSupportingContent: (external_prop_types_default()).func,
  id: (external_prop_types_default()).number.isRequired,
  puzzle: (external_prop_types_default()).object.isRequired,
  onPuzzleComplete: (external_prop_types_default()).func
};
